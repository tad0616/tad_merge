...
define('_MD_TADMERGE_MERGER_SELECT_EXISTING_TPL_FILE', 'or select an existing overprint file');
define('_MD_TADMERGE_MERGE', 'Merge the uploaded (or selected) data file with the overprinted file');
define('_MD_TADMERGE_MERGER_XLSX_FILE', 'Data Source');
define('_MD_TADMERGE_MERGER_TPL_FILE', 'application file');
define('_MD_TADMERGE_MERGER_MERGE_TO', 'apply to %s (%s)');
define('_MD_TADMERGE_MERGER_DOWNLOAD_ALL', 'Download all (%s individual files)');
define('_MD_TADMERGE_MERGER_REMERGE', 'Re-merge');
define('_MD_TADMERGE_MERGER_RUN', 'Perform Merger');
define('_MD_TADMERGE_MERGER_VIEW', 'View');
